...
setup(
    ...
    data_files=[
        ...
        ('share/' + package_name + '/launch', ['launch/single_robot_inference.launch.py']),   
        ('share/' + package_name + '/launch', ['launch/single_robot_inference_with_rosbag.launch.py']),
        ...
        ('share/' + package_name + '/config', ['config/waypoints_dk.yaml']),
